...
def all_roles_required(*roles, allow_staff=True, allow_superuser=True, login_url="login"):
    """
    Requiere que el usuario pertenezca a TODOS los roles indicados.
    """
    def predicate(u):
